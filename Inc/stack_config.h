...
#define OTA_GATT_ATTRIBUTES_CONF     (0)//1+9  /* 10 for OTA Service & characteristics */
...
#define NUM_SYNC_SLOTS_CONF                          (0U)//0U
#define WHITE_LIST_SIZE_LOG2_CONF                    (0U)//0U
//#define L2CAP_MPS_CONF                               (247)//247U ZAO
#define L2CAP_MPS_CONF                               (1024)//ZAO	 
...
#define NUM_OF_CONCURRENT_GATT_CLIENT_PROC_CONF         (1)//default (0) ZAO 	 
...
#define HS_STARTUP_TIME 780 // 780 us
